...
namespace diabloblazor.Services
{
    public class Interop
    {
        ...
        public GCHandle StoreSpawnUnmarshalledBegin(byte[] data, bool isSpawn)
        {
            var spawnMpqHandle = GCHandle.Alloc(data, GCHandleType.Pinned);
            _webAssemblyJSRuntime.InvokeUnmarshalled<bool, IntPtr, int, object>("interop.fileStore.storeSpawnUnmarshalledBegin", isSpawn, spawnMpqHandle.AddrOfPinnedObject(), data.Length);
